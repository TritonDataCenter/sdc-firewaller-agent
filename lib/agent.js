...
function FwAgent(opts) {
     ...
     * currently safe. This can be fixed to use two actually separate queues
     * once the minimum platform is raised past 20150219.
     *
     * See deps/fw-overlay/lib/locker.js for more information.
     */
